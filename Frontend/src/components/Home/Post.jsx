...
// const PostCard = ({ post, setPosts }) => {
//   const { username, companyName } = useUserContext();
//   const [isLiked, setIsLiked] = useState(false);
//   const [showComments, setShowComments] = useState(false);
//   const [localLikes, setLocalLikes] = useState(post.likes || 0);
//   const [localComments, setLocalComments] = useState(post.comments || []);
...
//   // Ensure proper name display (Company Name > Username > Unknown User)
//   const displayName = post.user?.companyName || post.user?.username || "Unknown User";

//   // Default Avatar (Placeholder)
//   const avatar = post.user?.avatar || "https://placehold.co/40/008080/FFF?text=U";
